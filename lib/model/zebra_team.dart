...
class ZebraTeam {
  ...
  ZebraTeam.fromJson(Map<String, dynamic>? json) {
    ...
    xs = (json['xs'] == null) ? null : (json['xs'] as List).cast<double>();
    ys = (json['ys'] == null) ? null : (json['ys'] as List).cast<double>();
  }

  Map<String, dynamic> toJson() {
    Map<String, dynamic> json = {};
    if (teamKey != null) json['team_key'] = teamKey;
    if (xs != null) json['xs'] = xs;
    if (ys != null) json['ys'] = ys;
    return json;
  }
  ...
  static List<ZebraTeam> listFromJson(List<dynamic>? json) {
    return json == null
        ? <ZebraTeam>[]
        : json.map((value) => ZebraTeam.fromJson(value)).toList();
  }
  ...
  static Map<String, ZebraTeam> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic value) => map[key] = ZebraTeam.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ZebraTeam-objects as value to a dart map
  static Map<String, List<ZebraTeam>> mapListFromJson(
      Map<String, dynamic> json) {
