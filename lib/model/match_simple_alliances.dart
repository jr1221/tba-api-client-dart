...
class MatchSimpleAlliances {
  ...
  MatchSimpleAlliances.fromJson(Map<String, dynamic>? json) {
    if (json == null) return;
    red = (json['red'] == null) ? null : MatchAlliance.fromJson(json['red']);
    blue = (json['blue'] == null) ? null : MatchAlliance.fromJson(json['blue']);
  }
  ...
  static List<MatchSimpleAlliances> listFromJson(List<dynamic> json) {
    return json == null
        ? <MatchSimpleAlliances>[]
        : json.map((value) => MatchSimpleAlliances.fromJson(value)).toList();
  }

  static Map<String, MatchSimpleAlliances> mapFromJson(
      Map<String, dynamic> json) {
    var map = Map<String, MatchSimpleAlliances>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) =>
          map[key] = MatchSimpleAlliances.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of MatchSimpleAlliances-objects as value to a dart map
  static Map<String, List<MatchSimpleAlliances>> mapListFromJson(
      Map<String, dynamic> json) {
