...
class EventDistrictPointsTiebreakers {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (qualWins != null) json['qual_wins'] = qualWins;
    return json;
  }
  ...
  static List<EventDistrictPointsTiebreakers> listFromJson(List<dynamic> json) {
    return json == null
        ? <EventDistrictPointsTiebreakers>[]
        : json
            .map((value) => EventDistrictPointsTiebreakers.fromJson(value))
            .toList();
  }

  static Map<String, EventDistrictPointsTiebreakers> mapFromJson(
      Map<String, dynamic>? json) {
    var map = Map<String, EventDistrictPointsTiebreakers>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) =>
          map[key] = EventDistrictPointsTiebreakers.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of EventDistrictPointsTiebreakers-objects as value to a dart map
  static Map<String, List<EventDistrictPointsTiebreakers>> mapListFromJson(
      Map<String, dynamic> json) {
