...
class Award {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (awardType != null) json['award_type'] = awardType;
    if (eventKey != null) json['event_key'] = eventKey;
    if (recipientList != null) json['recipient_list'] = recipientList;
  ...
  static List<Award> listFromJson(List<dynamic> json) {
    return json == null
        ? <Award>[]
        : json.map((value) => Award.fromJson(value)).toList();
  }
  ...
  static Map<String, Award> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic value) => map[key] = Award.fromJson(value));
    }
    return map;
  }
