...
class Team {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (schoolName != null) json['school_name'] = schoolName;
    ...
    if (rookieYear != null) json['rookie_year'] = rookieYear;
    if (motto != null) json['motto'] = motto;
    if (homeChampionship != null) json['home_championship'] = homeChampionship;
    return json;
  }
  ...
  static List<Team> listFromJson(List<dynamic> json) {
    return json == null
        ? <Team>[]
        : json.map((value) => Team.fromJson(value)).toList();
  }
  ...
  static Map<String, Team> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic value) => map[key] = Team.fromJson(value));
    }
    return map;
  }
