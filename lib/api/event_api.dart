...
class EventApi {
  ...
  ///
  /// Gets a list of events in the given district.
  Future<List<Event>> getDistrictEvents(String districtKey,
      {String? ifModifiedSince}) async {
  ...
  ///
  /// Gets an Event.
  Future<Response> getEventWithHttpInfo(String eventKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
  ...
  Future<Event> getEvent(String eventKey, {String? ifModifiedSince}) async {
    Response response =
        await getEventWithHttpInfo(eventKey, ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  Future<Response> getEventAlliancesWithHttpInfo(String eventKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/event/{event_key}/alliances"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "event_key" + "}", eventKey.toString());
  ...
  ///
  /// Gets a list of Elimination Alliances for the given Event.
  Future<List<EliminationAlliance>> getEventAlliances(String eventKey,
      {String? ifModifiedSince}) async {
    Response response = await getEventAlliancesWithHttpInfo(eventKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return (apiClient.deserialize(
              _decodeBodyBytes(response), 'List<EliminationAlliance>') as List)
          .map((item) => item as EliminationAlliance)
          .toList();
    } else {
      return List.empty();
    }
  ...
  Future<Response> getEventAwardsWithHttpInfo(String eventKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/event/{event_key}/awards"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "event_key" + "}", eventKey.toString());
  ...
  ///
  /// Gets a list of awards from the given event.
  Future<List<Award>> getEventAwards(String eventKey,
      {String? ifModifiedSince}) async {
    Response response = await getEventAwardsWithHttpInfo(eventKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  Future<Response> getEventDistrictPointsWithHttpInfo(String eventKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/event/{event_key}/district_points"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "event_key" + "}", eventKey.toString());
  ...
  ///
  /// Gets a list of team rankings for the Event.
  Future<EventDistrictPoints> getEventDistrictPoints(String eventKey,
      {String? ifModifiedSince}) async {
    Response response = await getEventDistrictPointsWithHttpInfo(eventKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return apiClient.deserialize(
              _decodeBodyBytes(response), 'EventDistrictPoints')
  ...
  Future<Response> getEventInsightsWithHttpInfo(String eventKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/event/{event_key}/insights"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "event_key" + "}", eventKey.toString());
  ...
  ///
  /// Gets a set of Event-specific insights for the given Event.
  Future<EventInsights> getEventInsights(String eventKey,
      {String? ifModifiedSince}) async {
    Response response = await getEventInsightsWithHttpInfo(eventKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return apiClient.deserialize(_decodeBodyBytes(response), 'EventInsights')
          as EventInsights;
    } else {
  ...
  ///
  /// Gets a list of matches for the given event.
  Future<List<Match>> getEventMatches(String eventKey,
      {String? ifModifiedSince}) async {
  ...
  Future<Response> getEventOPRsWithHttpInfo(String eventKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/event/{event_key}/oprs"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "event_key" + "}", eventKey.toString());
  ...
  ///
  /// Gets a set of Event OPRs (including OPR, DPR, and CCWM) for the given Event.
  Future<EventOPRs> getEventOPRs(String eventKey,
      {String? ifModifiedSince}) async {
    Response response = await getEventOPRsWithHttpInfo(eventKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return apiClient.deserialize(_decodeBodyBytes(response), 'EventOPRs')
          as EventOPRs;
    } else {
      return EventOPRs();
    }
  ...
  Future<Response> getEventPredictionsWithHttpInfo(String eventKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/event/{event_key}/predictions"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "event_key" + "}", eventKey.toString());
  ...
  ///
  /// Gets information on TBA-generated predictions for the given Event. Contains year-specific information. *WARNING* This endpoint is currently under development and may change at any time.
  Future<Object> getEventPredictions(String eventKey,
      {String? ifModifiedSince}) async {
    Response response = await getEventPredictionsWithHttpInfo(eventKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  ///
  /// Gets a list of team rankings for the Event.
  Future<Response> getEventRankingsWithHttpInfo(String eventKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/event/{event_key}/rankings"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "event_key" + "}", eventKey.toString());
  ...
  ///
  /// Gets a list of team rankings for the Event.
  Future<EventRanking> getEventRankings(String eventKey,
      {String? ifModifiedSince}) async {
    Response response = await getEventRankingsWithHttpInfo(eventKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return apiClient.deserialize(_decodeBodyBytes(response), 'EventRanking')
          as EventRanking;
    } else {
      return EventRanking();
    }
  ...
  Future<Response> getEventSimpleWithHttpInfo(String eventKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/event/{event_key}/simple"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "event_key" + "}", eventKey.toString());
  ...
  ///
  /// Gets a short-form Event.
  Future<EventSimple> getEventSimple(String eventKey,
      {String? ifModifiedSince}) async {
    Response response = await getEventSimpleWithHttpInfo(eventKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return apiClient.deserialize(_decodeBodyBytes(response), 'EventSimple')
          as EventSimple;
    } else {
      return EventSimple();
    }
  ...
  ///
  /// Gets a list of events in the given year.
  Future<List<Event>> getEventsByYear(int year,
      {String? ifModifiedSince}) async {
