...
class TeamApi {
  ...
  Future<Response> getDistrictRankingsWithHttpInfo(String districtKey,
    ...
    if (nullableContentType != null &&
      ...
      MultipartRequest mp = MultipartRequest('', Uri());
  ...
  ///
  /// Gets a list of &#x60;Team&#x60; objects that competed in events in the given district.
  Future<List<Team>> getDistrictTeams(String districtKey,
      {String? ifModifiedSince}) async {
  ...
  ///
  /// Gets a list of &#x60;Team&#x60; objects that competed in the given event.
  Future<List<Team>> getEventTeams(String eventKey,
      {String? ifModifiedSince}) async {
  ...
  Future<Response> getTeamWithHttpInfo(String teamKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
  ...
  Future<Team> getTeam(String teamKey, {String? ifModifiedSince}) async {
    Response response =
        await getTeamWithHttpInfo(teamKey, ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  Future<Response> getTeamAwardsWithHttpInfo(String teamKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/awards"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString());
  ...
  ///
  /// Gets a list of awards the given team has won.
  Future<List<Award>> getTeamAwards(String teamKey,
      {String? ifModifiedSince}) async {
    Response response = await getTeamAwardsWithHttpInfo(teamKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return (apiClient.deserialize(_decodeBodyBytes(response), 'List<Award>')
              as List)
          .map((item) => item as Award)
          .toList();
    } else {
      return List.empty();
      ;
  ...
  Future<Response> getTeamAwardsByYearWithHttpInfo(String teamKey, int year,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/awards/{year}"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString())
  ...
  ///
  /// Gets a list of awards the given team has won in a given year.
  Future<List<Award>> getTeamAwardsByYear(String teamKey, int year,
      {String? ifModifiedSince}) async {
    Response response = await getTeamAwardsByYearWithHttpInfo(teamKey, year,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  Future<Response> getTeamDistrictsWithHttpInfo(String teamKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/districts"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString());
  ...
  ///
  /// Gets an array of districts representing each year the team was in a district. Will return an empty array if the team was never in a district.
  Future<List<DistrictList>> getTeamDistricts(String teamKey,
      {String? ifModifiedSince}) async {
    Response response = await getTeamDistrictsWithHttpInfo(teamKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return (apiClient.deserialize(
              _decodeBodyBytes(response), 'List<DistrictList>') as List)
          .map((item) => item as DistrictList)
          .toList();
    } else {
      return List.empty();
      ;
  ...
  Future<Response> getTeamEventAwardsWithHttpInfo(
    ...
    // create path and map variables
    String path = "/team/{team_key}/event/{event_key}/awards"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString())
        .replaceAll("{" + "event_key" + "}", eventKey.toString());
  ...
  ///
  /// Gets a list of awards the given team won at the given event.
  Future<List<Award>> getTeamEventAwards(String teamKey, String eventKey,
      {String? ifModifiedSince}) async {
    Response response = await getTeamEventAwardsWithHttpInfo(teamKey, eventKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  ///
  /// Gets a list of matches for the given team and event.
  Future<List<Match>> getTeamEventMatches(String teamKey, String eventKey,
      {String? ifModifiedSince}) async {
  ...
  ///
  /// Gets a short-form list of matches for the given team and event.
  Future<List<Match>> getTeamEventMatchesSimple(String teamKey, String eventKey,
      {String? ifModifiedSince}) async {
  ...
  Future<Response> getTeamEventStatusWithHttpInfo(
      String teamKey, String eventKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/event/{event_key}/status"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString())
        .replaceAll("{" + "event_key" + "}", eventKey.toString());
  ...
  ///
  /// Gets the competition rank and status of the team at the given event.
  Future<TeamEventStatus> getTeamEventStatus(String teamKey, String eventKey,
      {String? ifModifiedSince}) async {
    Response response = await getTeamEventStatusWithHttpInfo(teamKey, eventKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return apiClient.deserialize(
          _decodeBodyBytes(response), 'TeamEventStatus') as TeamEventStatus;
    } else {
  ...
  Future<Response> getTeamEventsWithHttpInfo(String teamKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/events"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString());
  ...
  ///
  /// Gets a list of all events this team has competed at.
  Future<List<Event>> getTeamEvents(String teamKey,
      {String? ifModifiedSince}) async {
    Response response = await getTeamEventsWithHttpInfo(teamKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  Future<Response> getTeamEventsByYearWithHttpInfo(String teamKey, int year,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/events/{year}"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString())
        .replaceAll("{" + "year" + "}", year.toString());
  ...
  ///
  /// Gets a list of events this team has competed at in the given year.
  Future<List<Event>> getTeamEventsByYear(String teamKey, int year,
      {String? ifModifiedSince}) async {
    Response response = await getTeamEventsByYearWithHttpInfo(teamKey, year,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  Future<Response> getTeamEventsByYearKeysWithHttpInfo(String teamKey, int year,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/events/{year}/keys"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString())
        .replaceAll("{" + "year" + "}", year.toString());
  ...
  ///
  /// Gets a list of the event keys for events this team has competed at in the given year.
  Future<List<String>> getTeamEventsByYearKeys(String teamKey, int year,
      {String? ifModifiedSince}) async {
    Response response = await getTeamEventsByYearKeysWithHttpInfo(teamKey, year,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  Future<Response> getTeamEventsByYearSimpleWithHttpInfo(
    ...
    // create path and map variables
    String path = "/team/{team_key}/events/{year}/simple"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString())
        .replaceAll("{" + "year" + "}", year.toString());
  ...
  ///
  /// Gets a short-form list of events this team has competed at in the given year.
  Future<List<EventSimple>> getTeamEventsByYearSimple(String teamKey, int year,
      {String? ifModifiedSince}) async {
    Response response = await getTeamEventsByYearSimpleWithHttpInfo(
        teamKey, year,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
  ...
  Future<Response> getTeamEventsKeysWithHttpInfo(String teamKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/events/keys"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString());
  ...
  ///
  /// Gets a list of the event keys for all events this team has competed at.
  Future<List<String>> getTeamEventsKeys(String teamKey,
      {String? ifModifiedSince}) async {
    Response response = await getTeamEventsKeysWithHttpInfo(teamKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  Future<Response> getTeamEventsSimpleWithHttpInfo(String teamKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/events/simple"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString());
  ...
  ///
  /// Gets a short-form list of all events this team has competed at.
  Future<List<EventSimple>> getTeamEventsSimple(String teamKey,
      {String? ifModifiedSince}) async {
    Response response = await getTeamEventsSimpleWithHttpInfo(teamKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  ///
  /// Gets a list of matches for the given team and year.
  Future<List<Match>> getTeamMatchesByYear(String teamKey, int year,
      {String? ifModifiedSince}) async {
  ...
  Future<Response> getTeamMediaByTagWithHttpInfo(
      String teamKey, String mediaTag,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/media/tag/{media_tag}"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString())
        .replaceAll("{" + "media_tag" + "}", mediaTag.toString());
  ...
  ///
  /// Gets a list of Media (videos / pictures) for the given team and tag.
  Future<List<Media>> getTeamMediaByTag(String teamKey, String mediaTag,
      {String? ifModifiedSince}) async {
    Response response = await getTeamMediaByTagWithHttpInfo(teamKey, mediaTag,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return (apiClient.deserialize(_decodeBodyBytes(response), 'List<Media>')
              as List)
  ...
  Future<Response> getTeamMediaByTagYearWithHttpInfo(
    ...
    // create path and map variables
    String path = "/team/{team_key}/media/tag/{media_tag}/{year}"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString())
        .replaceAll("{" + "media_tag" + "}", mediaTag.toString())
        .replaceAll("{" + "year" + "}", year.toString());
  ...
  Future<List<Media>> getTeamMediaByTagYear(
      String teamKey, String mediaTag, int year,
      {String? ifModifiedSince}) async {
    Response response = await getTeamMediaByTagYearWithHttpInfo(
        teamKey, mediaTag, year,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  Future<Response> getTeamMediaByYearWithHttpInfo(String teamKey, int year,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/media/{year}"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString())
        .replaceAll("{" + "year" + "}", year.toString());
  ...
  ///
  /// Gets a list of Media (videos / pictures) for the given team and year.
  Future<List<Media>> getTeamMediaByYear(String teamKey, int year,
      {String? ifModifiedSince}) async {
    Response response = await getTeamMediaByYearWithHttpInfo(teamKey, year,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  Future<Response> getTeamRobotsWithHttpInfo(String teamKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/robots"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString());
  ...
  ///
  /// Gets a list of year and robot name pairs for each year that a robot name was provided. Will return an empty array if the team has never named a robot.
  Future<List<TeamRobot>> getTeamRobots(String teamKey,
      {String? ifModifiedSince}) async {
    Response response = await getTeamRobotsWithHttpInfo(teamKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return (apiClient.deserialize(
              _decodeBodyBytes(response), 'List<TeamRobot>') as List)
          .map((item) => item as TeamRobot)
          .toList();
    } else {
      return List.empty();
      ;
  ...
  Future<Response> getTeamSimpleWithHttpInfo(String teamKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/simple"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString());
  ...
  ///
  /// Gets a &#x60;Team_Simple&#x60; object for the team referenced by the given key.
  Future<TeamSimple> getTeamSimple(String teamKey,
      {String? ifModifiedSince}) async {
    Response response = await getTeamSimpleWithHttpInfo(teamKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return apiClient.deserialize(_decodeBodyBytes(response), 'TeamSimple')
          as TeamSimple;
    } else {
      return TeamSimple();
      ;
  ...
  Future<Response> getTeamSocialMediaWithHttpInfo(String teamKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/social_media"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString());
  ...
  ///
  /// Gets a list of Media (social media) for the given team.
  Future<List<Media>> getTeamSocialMedia(String teamKey,
      {String? ifModifiedSince}) async {
    Response response = await getTeamSocialMediaWithHttpInfo(teamKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
  ...
  Future<Response> getTeamYearsParticipatedWithHttpInfo(String teamKey,
      {String? ifModifiedSince}) async {
    Object? postBody;
    ...
    // create path and map variables
    String path = "/team/{team_key}/years_participated"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "team_key" + "}", teamKey.toString());
  ...
  ///
  /// Gets a list of years in which the team participated in at least one competition.
  Future<List<int>> getTeamYearsParticipated(String teamKey,
      {String? ifModifiedSince}) async {
    Response response = await getTeamYearsParticipatedWithHttpInfo(teamKey,
        ifModifiedSince: ifModifiedSince);
    if (response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if (response.body != null) {
      return (apiClient.deserialize(_decodeBodyBytes(response), 'List<int>')
              as List)
  ...
  ///
  /// Gets a list of &#x60;Team&#x60; objects that competed in the given year, paginated in groups of 500.
  Future<List<Team>> getTeamsByYear(int year, int pageNum,
      {String? ifModifiedSince}) async {
